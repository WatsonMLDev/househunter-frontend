        ...
        <section>
          <div className="flex justify-between items-center mb-4">
             <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-slate-200 tracking-tight">Drive Time Zones</h3>
             </div>
          </div>
          <div className="flex flex-col gap-2">
            {tiers.map((tier) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                      <div className={`w-2 h-2 rounded-full ${tier === HunterTier.GOLD ? 'bg-yellow-400' : tier === HunterTier.SILVER ? 'bg-slate-400' : 'bg-orange-500'}`}></div>
                      <span>{tier}</span>
                  </div>
